...
fn payout_should_work() {
	ExtBuilder::default().collator_count(5).build().execute_with(|| {
		...
		let rewards = [
			...
			2550088512393184504844,
			3551909019701415672898,
			4371580342869154734956,
			5009102454574024616391,
			4098356544800514916261,
			2914386902532070376538,
			1912566395223839208483,
			1092895072056100146426,
			455372960351230264991,
		];
		(1..=10)
			.zip(rewards.iter())
