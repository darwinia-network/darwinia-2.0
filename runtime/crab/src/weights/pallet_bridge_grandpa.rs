...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, v: u32, ) -> Weight {
		// Minimum execution time: 1_747_506 nanoseconds.
		Weight::from_ref_time(122_625_554)
			// Standard Error: 65_123
			.saturating_add(Weight::from_ref_time(30_717_136).saturating_mul(p.into()))
			// Standard Error: 66_669
			.saturating_add(Weight::from_ref_time(1_020_564).saturating_mul(v.into()))
