...
impl<T: frame_system::Config> pallet_fee_market::WeightInfo for WeightInfo<T> {
	...
	fn enroll_and_lock_collateral() -> Weight {
		// Minimum execution time: 85_870 nanoseconds.
		Weight::from_ref_time(88_057_000)
	...
	fn increase_locked_collateral() -> Weight {
		// Minimum execution time: 83_105 nanoseconds.
		Weight::from_ref_time(84_974_000)
			.saturating_add(T::DbWeight::get().reads(15))
	...
	fn decrease_locked_collateral() -> Weight {
		// Minimum execution time: 90_842 nanoseconds.
		Weight::from_ref_time(97_177_000)
			.saturating_add(T::DbWeight::get().reads(15))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	// Storage: PangoroFeeMarket Relayers (r:1 w:0)
	...
	fn update_relay_fee() -> Weight {
		// Minimum execution time: 70_291 nanoseconds.
	...
	fn cancel_enrollment() -> Weight {
		// Minimum execution time: 83_522 nanoseconds.
		Weight::from_ref_time(87_984_000)
			.saturating_add(T::DbWeight::get().reads(15))
			.saturating_add(T::DbWeight::get().writes(5))
	}
	...
	fn set_slash_protect() -> Weight {
		...
		Weight::from_ref_time(9_802_000)
	...
	fn set_assigned_relayers_number() -> Weight {
		// Minimum execution time: 67_186 nanoseconds.
		Weight::from_ref_time(71_184_000)
