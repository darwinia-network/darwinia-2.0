...
impl<T: frame_system::Config> pallet_balances::WeightInfo for WeightInfo<T> {
	...
	fn transfer() -> Weight {
		...
		Weight::from_ref_time(29_031_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: System Account (r:1 w:1)
	fn transfer_keep_alive() -> Weight {
		// Minimum execution time: 24_687 nanoseconds.
	...
	fn set_balance_killing() -> Weight {
		// Minimum execution time: 19_249 nanoseconds.
		Weight::from_ref_time(20_607_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn force_transfer() -> Weight {
		...
		Weight::from_ref_time(29_641_000)
	...
	fn transfer_all() -> Weight {
		...
		Weight::from_ref_time(30_578_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: System Account (r:1 w:1)
	fn force_unreserve() -> Weight {
		// Minimum execution time: 15_431 nanoseconds.
		Weight::from_ref_time(17_130_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
