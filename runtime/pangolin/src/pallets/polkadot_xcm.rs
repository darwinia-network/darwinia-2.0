	...
	(
		...
		WithComputedOrigin<
			(
				...
				xcm_builder::AllowExplicitUnpaidExecutionFrom<darwinia_common_runtime::xcm_configs::ParentOrParentsExecutivePlurality>,
...
frame_support::parameter_types! {
	...
	pub UnitWeightCost: u64 = Weight::from_parts(1_000_000_000, 64 * 1024);
}
