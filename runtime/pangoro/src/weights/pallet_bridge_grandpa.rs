...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, v: u32, ) -> Weight {
		// Minimum execution time: 1_738_247 nanoseconds.
		Weight::from_ref_time(107_655_515)
			// Standard Error: 45_482
			.saturating_add(Weight::from_ref_time(30_495_014).saturating_mul(p.into()))
			// Standard Error: 46_561
			.saturating_add(Weight::from_ref_time(1_247_203).saturating_mul(v.into()))
