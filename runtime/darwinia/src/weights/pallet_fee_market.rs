...
impl<T: frame_system::Config> pallet_fee_market::WeightInfo for WeightInfo<T> {
	...
	fn enroll_and_lock_collateral() -> Weight {
		// Minimum execution time: 87_788 nanoseconds.
		Weight::from_ref_time(102_364_000)
	...
	fn increase_locked_collateral() -> Weight {
		// Minimum execution time: 92_166 nanoseconds.
		Weight::from_ref_time(167_288_000)
			.saturating_add(T::DbWeight::get().reads(15))
	...
	fn decrease_locked_collateral() -> Weight {
		// Minimum execution time: 92_680 nanoseconds.
		Weight::from_ref_time(101_637_000)
			.saturating_add(T::DbWeight::get().reads(15))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	// Storage: CrabFeeMarket Relayers (r:1 w:0)
	...
	fn update_relay_fee() -> Weight {
		...
		Weight::from_ref_time(72_606_000)
	...
	fn cancel_enrollment() -> Weight {
		// Minimum execution time: 83_190 nanoseconds.
		Weight::from_ref_time(88_436_000)
			.saturating_add(T::DbWeight::get().reads(15))
			.saturating_add(T::DbWeight::get().writes(5))
	}
	...
	fn set_slash_protect() -> Weight {
		...
		Weight::from_ref_time(9_686_000)
	...
	fn set_assigned_relayers_number() -> Weight {
		// Minimum execution time: 69_596 nanoseconds.
		Weight::from_ref_time(91_298_000)
